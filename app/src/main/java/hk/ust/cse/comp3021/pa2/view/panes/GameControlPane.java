...
public class GameControlPane extends GridPane implements GameUIComponent {
    ...
    private void move(@NotNull Direction direction) {
        ...
        MoveEvent e = new MoveEvent(gameController.processMove(direction));
    ...
    private void setUndoButtonLayout() {
        ...
        undoButton.setOnAction(event -> performUndo());
        //throw new NotImplementedException();
    }
    ...
    private void setMoveButtonsHandler() {
        ...
        upButton.setOnAction(event -> this.move(Direction.UP));
        downButton.setOnAction(event -> this.move(Direction.DOWN));
        leftButton.setOnAction(event -> this.move(Direction.LEFT));
        rightButton.setOnAction(event -> this.move(Direction.RIGHT));
        //throw new NotImplementedException();
    }
